  ...
  >
    ...
    <div class="p-6">
      ...
      <div class="flex justify-between items-center">
        <span class="text-sm text-pink-400 font-medium">{{ quiz.questions.length }} questions</span>
...
const localImageMap = {
  'Quiz de Culture Générale': '/images/cg.png',
  'Quiz de Sciences': '/images/science.png',
  'Histoire Mondiale': '/images/histoire.png',
  'Astronomie Avancée': '/images/astro.png',
  'Sport et Jeux Olympiques': '/images/sport.png',
  'Musique Pop': '/images/musique.png',
  'Cinéma et Films Cultes': '/images/cinema.png',
  'Géographie Mondiale': '/images/geographie.png',
  'Programmation Informatique': '/images/informatique.png',
  'Gastronomie Mondiale': '/images/gastronomie.png'
};
...
function getOnlineImage() {
  ...
  if (title.includes('gastronomie')) return onlineImages.gastronomie;
